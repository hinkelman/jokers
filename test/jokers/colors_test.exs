defmodule Jokers.ColorsTest do
  ...
  test "getting colors" do
    ...
    assert Colors.get_next_teammate(colors4, :black, %{
             blue: %{0 => nil, 1 => :blue, 2 => :blue, 3 => :blue, 4 => :blue}
           }) == :blue

    assert Colors.get_next_teammate(colors6, :black, %{
             blue: %{0 => nil, 1 => :blue, 2 => :blue, 3 => :blue, 4 => :blue}
           }) == :blue

    assert Colors.get_next_teammate(colors6, :black, %{
             blue: %{0 => :blue, 1 => :blue, 2 => :blue, 3 => :blue, 4 => :blue}
           }) == :green
  end
end
